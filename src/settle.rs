...
mod tests {
    ...
    const CAPTURED_TEXT_STREAM: [&str; 6] = [
        r#"{"type": "message_start", "message": {"model": "claude-opus-5", "id": "msg_762xvdb",
    ...
    fn a_captured_text_stream_settles() {
        ...
        assert_eq!(settled.id, "msg_762xvdb");
    ...
    fn a_captured_tool_use_stream_settles_into_one_call() {
        let mut payloads = vec![
            r#"{"type": "message_start", "message": {"model": "claude-opus-5", "id": "msg_rcgr6ir",
        ...
        assert_eq!(calls[0].id, "toolu_01SfSun6GdgxKVDToTxtf7Ee");
